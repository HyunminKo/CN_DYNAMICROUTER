...
/*
- MakeList()메소드를 이용해서 주어진 문자열을 나눈모습
sBuff : File
pcList : ( *Ethernet ( *ChatApp ( *ChatDlg ) ) )

sBuff : (
pcList : *Ethernet ( *ChatApp ( *ChatDlg ) ) )

sBuff : *Ethernet
pcList : ( *ChatApp ( *ChatDlg ) ) )
...
FileLayer push한후 FileLayer->SetUpperUnderLayer(EthernetLayer),
EthernetLayer push한후 EthernetLayer->SetUpperUnderLayer(ChatAppLayer),
ChatAppLayer push한후 ChatAppLayer->SetUpperUnderLayer(ChatDlgLayer),
pop 3번 후 스택은 빔.
*/
