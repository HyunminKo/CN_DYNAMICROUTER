...
public:
	...
	virtual	BOOL	Send( unsigned char* ppayload, int nlength)	{ return FALSE ; }	
	virtual	BOOL	Send( unsigned char* ppayload, int nlength, unsigned char *srcMAC, unsigned char *srcIP, unsigned char *deviceName,unsigned char *deviceDescriptor)
					{ return FALSE ; }
	// param : unsigned char*	- the data of the underlayer
	virtual	BOOL	Receive( unsigned char* ppayload ) 	{ return FALSE ; } 
	virtual BOOL	Receive(unsigned char *ppayload, unsigned char *srcMAC, unsigned char *srcIP, unsigned char *deviceName,unsigned char *deviceDescriptor)
					{return FALSE ;	}
